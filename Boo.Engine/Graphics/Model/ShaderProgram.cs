...
public struct ShaderProgramCreateInfo : IBooCreateInfo
{
    ...
    public ShaderProgramCreateInfo()
    {
    }
...
public sealed class ShaderProgram : BooAsset
{
    ...
    {
        Dispose();
        throw new BooException("ShaderProgram not disposed properly");
    }
